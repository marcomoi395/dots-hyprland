...
-- 	{ ignore_mods = true, transparent = true, release = true }
-- )
hl.bind("SUPER + A", hl.dsp.global("quickshell:overviewWorkspacesToggle"), { description = "Shell: Toggle overview" })
...
hl.bind("SUPER + C", hl.dsp.exec_cmd("google-chrome-stable"), { description = "App: Browser" })
hl.bind(
    "F12",
